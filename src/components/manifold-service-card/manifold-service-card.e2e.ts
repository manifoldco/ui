...
describe('<manifold-service-card>', () => {
  it('displays name', async () => {
    const page = await newE2EPage({
      html: `<manifold-service-card name="${name}"></manifold-service-card>`,
    });
  ...
  it('displays description', async () => {
    const page = await newE2EPage({
      html: `<manifold-service-card description="${description}"></manifold-service-card>`,
    });
  ...
  it('displays logo', async () => {
    const page = await newE2EPage({
      html: `<manifold-service-card logo="${logo}"></manifold-service-card>`,
    });
  ...
  it('displays a featured tag if featured', async () => {
    const page = await newE2EPage({
      html: `<manifold-service-card is-featured="true"></manifold-service-card>`,
    });
  ...
  it('has an is-custom class if custom', async () => {
    const page = await newE2EPage({
      html: `<manifold-service-card is-custom="true"></manifold-service-card>`,
    });
